          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h1 class="text-center"><b>Categorized Patient's Report</h1></b>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
                    ...
                    <div class="form-group">
                        <input type="submit" name="select" value="Select" class="btn btn-lg btn-white bg-primary" style="margin-left:500px;">
                    </div>
                  </form>
...
$sql1="SELECT * from patient p, category c where p.catid=c.catid and p.catid=$category";
